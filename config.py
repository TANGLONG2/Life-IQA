...
_C.MODEL.CONVNEXT.EMBED_DIM = 384
_C.MODEL.CONVNEXT.PRETRAINED = True
_C.MODEL.CONVNEXT.PRETRAINED_MODEL_PATH = ""

# ResNet
_C.MODEL.RESNET = CN()
_C.MODEL.RESNET.EMBED_DIM = 384

# EfficientNet
_C.MODEL.EFFICIENTNET = CN()
_C.MODEL.EFFICIENTNET.EMBED_DIM = 384

# MOBIELNET
_C.MODEL.MOBIELNET = CN()
_C.MODEL.MOBIELNET.EMBED_DIM = 384

# SWIN
_C.MODEL.SWIN = CN()
_C.MODEL.SWIN.EMBED_DIM = 384
_C.MODEL.SWIN.JUERY_NUMS = 6
_C.MODEL.SWIN.NUM_EXPERTS = 8
_C.MODEL.SWIN.TOP_K = 2
_C.MODEL.SWIN.DEPTH = 4

# PVT
_C.MODEL.PVT = CN()
_C.MODEL.PVT.EMBED_DIM = 384

# MaxVIT
_C.MODEL.MAXVIT = CN()
_C.MODEL.MAXVIT.EMBED_DIM = 384
...
def update_config(config, args, local_rank):
    ...
    if args.num_experts:
        config.MODEL.SWIN.NUM_EXPERTS = args.num_experts
    if args.top_k:
        config.MODEL.SWIN.TOP_K = args.top_k
